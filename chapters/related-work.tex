...
aprendizado por reforço e uma rede neural convolucional treinada com uma
variante de \textit{Q-learning} para criar o agente.
...
recebidas ainda era considerávelmente grande. Por isto, a utilização de
