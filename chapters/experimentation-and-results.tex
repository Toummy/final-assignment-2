...
\todoin[caption={Experimentos Realizados}, color=cyan!60] {
    ...
    \begin{itemize}
        ...
        \item Experimento \#1: tamanho da janela de visão. Mapas: \textbf{easy, medium}.
        \item Experimento \#2: diferentes valores de fitness. Mapas: \textbf{easy, medium}.
        \item Experimento \#3: configurações de mutação. Mapas: \textbf{easy, medium}.
        \item Checkpoint: definir tamanho da janela de visão, valor de fitness e configurações do NEAT.
        ...
        \item Experimento \#5: experimentos nos cenários convencionais.
    \end{itemize}
}
