...
\todoin[caption={Experimentos Realizados}, color=cyan!60] {
	...
	\begin{itemize}
		...
		\item Experimento \#2: janela de visão: 5x5, 7x7. Mapas: \textbf{medium}.
		...
		\item Não vai funcionar a fitness (local ótimo).
		\item Experimento \#4: fitness exploratória.
        \item Checkpoint: fitness exploratória não funcionou.
		\item Experimento \#5: fitness com A*.
		\item Checkpoint: selecionar nova fitness (caso ocorra melhoria)
		\item Experimento \#6: rodar mapa hard com as configurações definidas
        \item Experimento \#7: experimentos nos cenários especificos.
    \end{itemize}
