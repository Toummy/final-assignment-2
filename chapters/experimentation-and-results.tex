...
\todoin[caption={Experimentos Realizados}, color=cyan!60] {
    ...
    \begin{itemize}
        ...
        \item Experimento #1: tamanho da janela de visão. Mapas: \texbf{easy, medium}.
        \item Experimento #2: diferentes valores de fitness. Mapas: \texbf{easy, medium}.
        \item Experimento #3: configurações de mutação. Mapas: \texbf{easy, medium}.
