...
\todoin[caption={Verificar com o Meneguzzi qual nome se encaixa melhor, ao
invés de ''Projeto``}, color=red!70] {
    Verificar com o Meneguzzi qual nome se encaixa melhor, ao invés de
    ''Projeto``.
}
...
\todoin[caption={Verificar com o Meneguzzi como explicar melhor a saída de
Behavior Trees.}, color=red!70] {
    Verificar com o Meneguzzi como explicar melhor a saída de Behavior Trees.
}
