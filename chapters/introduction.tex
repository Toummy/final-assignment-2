...
qualidade dos agentes. Por fim, examinamos os resultados obtidos e os
comparamos a outras implementações de agentes inteligentes em \textit{Spelunky}
a fim de atestar a eficácia da técnica escolhida para resolver o problema
selecionado.
...
viabilizam a construção deste trabalho. No Capítulo \ref{chap:development}
