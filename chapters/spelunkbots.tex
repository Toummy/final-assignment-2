...
joguem entre si. Um exemplo disso é a competição que gira em torno de
...
\textbf{Mario AI Competition}, por exemplo, possuía como uma de suas metas a
...
\subsection{\label{section:spelunkbots-commands}Enviando Comandos para o
\textit{Bot}}
