...
\foreach \l [count=\i] in {1,n}
  \node [above] at (hidden-\i.north) {$I_\l$};
...
\node [align=center, above, font=\scriptsize] at (0,2) {Camada de \\ Entrada};
\node [align=center, above, font=\scriptsize] at (2,2) {Camadas Intermediárias \\ (Escondidas)};
\node [align=center, above, font=\scriptsize] at (4,2) {Camada de \\ Saída};
...
Os \textbf{algoritmos evolutivos} se baseiam neste processo biológico 
