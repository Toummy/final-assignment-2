...
\begin{enumerate}
	...
	\item Armadilhas: necessitam de uma sequência de, no mínimo, 2 espaços
	vazios para a esquerda ou para a direita. São geradas do início até a metade
	do nível, não muito próximas da entrada.
\end{enumerate}
