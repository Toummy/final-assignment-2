...
exemplifica um resultado desta etapa do algoritmo.
...
tipo possui em torno de 6 a 12 modelos. Cada sala em Spelunky é representada por
uma grade 10 por 8 de \textit{tiles}\footnote{Tipo de representação visual muito
utilizada por jogos 2D para dispor os elementos de um jogo em forma de grade,
onde cada elemento se chama \textit{tile}.} e os modelos são descritos através
de arquivos de texto contendo uma sequência de 80 caracteres. A Tabela
\ref{tab:spelunky-procgen-rooms-tiles} lista os diversos tipos de \textit{tiles}
