...
\begin{figure}[htb!]
\centering
\includegraphics[width=.35\textwidth]{fig/spelunky-procgen-examples.png}
\caption{\label{fig:spelunky-procgen-examples} Exemplos do resultado final do
algoritmo de geração de níveis de Spelunky para a área das Cavernas.}
\end{figure}

% TODO:usar isto para tirar screenshots dos níveis prontos:
...
destes inclusive causam a morte instantânea do jogador. A Tabela
\ref{tab:spelunky-obstacles} apresenta a relação de monstros e armadilhas, bem
como uma breve descrição de seus comportamentos.

\begin{table}[htb!]
\centering
\caption{Objetivos por Iteração}
\label{tab:spelunky-obstacles}
\begin{tabular}{|c|c|}
\hline
\textbf{Obstáculo}	& \textbf{Descrição} \\ \hline
Espinhos			& TBD \\ \hline
Lança-flechas		& TBD \\ \hline
Pedregulho			& TBD \\ \hline
Armadilha Tiki		& TBD \\ \hline
Armadilha de salto	& TBD \\ \hline
Campo de força		& TBD \\ \hline
Armadilha esmagadora& TBD \\ \hline
Teto espinhento		& TBD \\ \hline
Gelo fino			& TBD \\ \hline
Baú falso			& TBD \\ \hline
Vaso falso			& TBD \\ \hline
Cobra				& TBD \\ \hline
Morçego				& TBD \\ \hline
Aranha				& TBD \\ \hline
Aranha gigante		& TBD \\ \hline
Esqueleto			& TBD \\ \hline
Homem das Cavernas	& TBD \\ \hline
Sapo				& TBD \\ \hline
Sapo flamejante		& TBD \\ \hline
Planta carnívora	& TBD \\ \hline
Piranha				& TBD \\ \hline
Piranha gigante		& TBD \\ \hline
Macaco				& TBD \\ \hline
Jiang Shi			& TBD \\ \hline
Vampiro				& TBD \\ \hline
Fantasma			& TBD \\ \hline
Ieti				& TBD \\ \hline
Ieti rei			& TBD \\ \hline
Alienígena			& TBD \\ \hline
OVNI				& TBD \\ \hline
Alienígena Lorde	& TBD \\ \hline
Homem Gavião		& TBD \\ \hline
Homem Magma			& TBD \\ \hline
Múmia				& TBD \\ \hline
Olmec				& TBD \\ \hline
\end{tabular}
\end{table}
...
\begin{itemize}
    \item
        Listar os inimigos
    \item
        Listar as armadilhas
    \item
        Listar os obstáculos impostos pelo ambiente (quedas, lava, etc.)
\end{itemize}
\end{mdframed}
...
\begin{itemize}
    \item
        Listar os itens e suas categorias
    \item
        Breve explicação
\end{itemize}
\end{mdframed}
