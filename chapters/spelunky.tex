...
\begin{description}
	...
	alguns casos, o jogador pode carregar mais de um consumível consigo. Alguns
	exemplo são as bombas, as cordas e o pára-quedas.
	...
	manifestados através de um bônus passivo ou através de uma ativação.  Alguns
	exemplos são o compasso, os sapatos de mola e a capa.
